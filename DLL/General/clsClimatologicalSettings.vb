Public Class clsClimatologicalSettings
  ...
  Public Function GetMeteoHalfYear(ByVal myDate As Date) As STOCHLIB.GeneralFunctions.enmSeason
  ...
  Public Sub GetPreviousMeteoHalfYear(ByVal myDate As Date, ByRef prevYear As Integer, ByRef PrevSeason As STOCHLIB.GeneralFunctions.enmSeason)
    Dim curSeason As STOCHLIB.GeneralFunctions.enmSeason = GetMeteoHalfYear(myDate)
