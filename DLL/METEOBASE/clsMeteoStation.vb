...
Public Class clsMeteoStation
    ...
    Public Number As Integer          'station number. e.g. for HBV used in the meteo txt file itself
    Public Lat As Double
    Public Lon As Double
    Public X As Double
    Public Y As Double
    Public StationType As STOCHLIB.GeneralFunctions.enmMeteoStationType
