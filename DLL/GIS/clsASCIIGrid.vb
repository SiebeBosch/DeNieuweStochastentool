...
Public Class clsASCIIGrid
  ...
  End Sub
    ...
    Friend Function ReadHeader(ByRef ascReader As StreamReader) As Boolean
        Try
            ...
            Me.setup.GeneralFunctions.UpdateProgressBar("Reading grid header...", 0, 1)
    ...
    path = myPath
        Dim row As Integer, col As Integer, entry As String
        Using ascreader As New StreamReader(path)

            ReadHeader(ascreader)
            ...
            Me.setup.GeneralFunctions.UpdateProgressBar("Reading grid data...", 0, rows)

            'now read the griddata
            For row = 1 To rows
                Me.setup.GeneralFunctions.UpdateProgressBar("", row, rows)
                entry = ascreader.ReadLine.Trim
                For col = 1 To cols
  ...
  Friend Function GetRCExtents(ByVal x_from As Double, ByVal x_to As Double, ByVal y_from As Double, ByVal y_to As Double, _
