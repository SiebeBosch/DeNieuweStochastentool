                ...
                If radZomWin.Checked Then
                    ...
                    For i = 1 To 2
                        ...
                        Else
                            ...
                            Seizoensnaam = "winter"
                        End If
                        Call Me.Setup.StochastenAnalyse.ClassifyGroundwaterRRBySeason(seizoen, cmbDuration.Text, myCase, grGrondwaterKlassen, Seizoensnaam, Dates, chkSeepage.Checked, ExportDir)
                    Next
