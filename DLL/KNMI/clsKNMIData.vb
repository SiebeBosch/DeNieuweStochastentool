...
Public Class clsKNMIData
  ...
  Public Function calcHourlyEventStats(ByVal myArea As Double) As Boolean
    Dim i As Integer = 0
    Me.Setup.GeneralFunctions.UpdateProgressBar("Calculating statistics for precipitation.", 0, 10)
    For Each myStation As clsKNMIStationHourly In StationsHourly
      i += 1
      Me.Setup.GeneralFunctions.UpdateProgressBar("Calculating statistics for station " & myStation.Number, i, StationsHourly.Count)
  ...
  Public Sub readMBTextFile(ByVal myFile As String)
    ...
    Me.Setup.GeneralFunctions.UpdateProgressBar("Reading meteo file " & myFile, 0, 10)
