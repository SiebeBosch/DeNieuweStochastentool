...
#define MyAppName "DIMR_RUNR"
#define MyAppVersion "2.500"
...
AppId={{4bc997af-9c48-4f6e-8ba0-7461ac95f438}
AppName={#MyAppName}
...
OutputBaseFilename=DIMR_RUNR_Setup-v{#MyAppVersion}-{#CPU}
...
[Messages]
BeveledLabel=DIMR_RUNR by Hydroconsult

[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\DIMR_RUNR.exe"; WorkingDir: "{app}"; Comment: "Start DIMR_RUNR"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\DIMR_RUNR.exe"; WorkingDir: "{app}"; Comment: "Start DIMR_RUNR"
...
Filename: "{app}\DIMR_RUNR.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start DIMR_RUNR?"
