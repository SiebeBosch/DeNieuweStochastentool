...
AppId={{6158CF3F-D355-4D43-991B-FC7C9D4DA2BB}
AppName={#MyAppName}
...
InfoBeforeFile={#SetupLocation}\releasenotes_bat_runr.txt
OutputDir={#SetupLocation}
OutputBaseFilename=BAT_RUNR_Setup-v{#MyAppVersion}-{#CPU}
...
[Messages]
BeveledLabel=BAT_RUNR by Hydroconsult

[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\BAT_RUNR.exe"; WorkingDir: "{app}"; Comment: "Start BAT_RUNR"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\BAT_RUNR.exe"; WorkingDir: "{app}"; Comment: "Start BAT_RUNR"
...
#endif
Filename: "{app}\BAT_RUNR.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start BAT_RUNR?"
